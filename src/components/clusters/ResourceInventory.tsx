              ...
              <Tabs defaultValue="deployments" className="w-full">
                ...
                <TabsContent value="statefulSets" className="mt-2">
                  <div className="p-4 border-b flex justify-between items-center">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {selectedCounts.statefulSets} of {statefulSets.length} stateful sets selected
                    </div>
                  </div>
                  <ScrollArea className="h-[400px]">
                    <Table>
                ...
                <TabsContent value="daemonSets" className="mt-2">
                  <div className="p-4 border-b flex justify-between items-center">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {selectedCounts.daemonSets} of {daemonSets.length} daemon sets selected
                    </div>
                  </div>
                  <ScrollArea className="h-[400px]">
                    <Table>
                ...
                <TabsContent value="replicaSets" className="mt-2">
                  <div className="p-4 border-b flex justify-between items-center">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {selectedCounts.replicaSets} of {replicaSets.length} replica sets selected
                    </div>
                  </div>
                  <ScrollArea className="h-[400px]">
                    <Table>
                ...
                <TabsContent value="cronJobs" className="mt-2">
                  <div className="p-4 border-b flex justify-between items-center">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {selectedCounts.cronJobs} of {cronJobs.length} cron jobs selected
                    </div>
                  </div>
                  <ScrollArea className="h-[400px]">
                    <Table>
